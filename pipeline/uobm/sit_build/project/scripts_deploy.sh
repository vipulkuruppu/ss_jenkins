#!/bin/ksh
################################################################
# PLCE scripts deploy script for jenkins
...
case ${deploy_env} in
	"sit"	) deploy_path=/app/CLSMY/MY/bin;
			  deploy_env_label="SIT-BAU";;
	"sit2"	) deploy_path=/app/CLSMY/MY2/bin;
			  deploy_env_label="SIT2-Project";;
	"sit5"	) deploy_path=/app/CLSMY/MY5/bin;
...
cd /TCM/UAT_svr/${release}/deploy/bin
cp -pR * ${deploy_path}
